...
public class AttentionTitleDecoration extends RecyclerView.ItemDecoration {
    ...
    public AttentionTitleDecoration(Context context, DecorationCallback decorationCallback) {
        Resources res = context.getResources();
        this.callback = decorationCallback;
        //设置悬浮栏的画笔---paint
        paint = new Paint();
        paint.setColor(res.getColor(R.color.lineColor));
        ...
        //决定悬浮栏的高度等
        topGap = res.getDimensionPixelSize(R.dimen.dp_32);
        //决定文本的显示位置等
        alignBottom = res.getDimensionPixelSize(R.dimen.dp_6);
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (pos == 0 || isFirstInGroup(pos)) {
            outRect.top = topGap;
            if (callback.getGroupFirstLine(pos) == "") {
                outRect.top = 0;
            }
        } else {
            outRect.top = 0;
...
//                }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            c.drawRect(left, textY - topGap, right, textY + alignBottom, paint);
