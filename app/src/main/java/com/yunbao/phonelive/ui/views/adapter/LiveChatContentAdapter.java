...
public class LiveChatContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//            default:
        return new LiveChatHorizontalVh(viewGroup, listener);
//        }
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof LiveChatHorizontalVh) {
            ((LiveChatHorizontalVh) viewHolder).bindData(datas.get(i));
        }
