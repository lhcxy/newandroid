...
public class LiveTypeChannelBSFragment extends BottomSheetDialogFragment {
    ...
    public static LiveTypeChannelBSFragment newInstance() {
        LiveTypeChannelBSFragment fragment = new LiveTypeChannelBSFragment();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.dialog_live_channel_bottomsheet, container, false);
        ...
        RxView.clicks(rootView.findViewById(R.id.bottom_sheet_close_iv)).throttleFirst(AppConfig.CLICK_DURATION, TimeUnit.MILLISECONDS)
                .subscribe(o -> dismiss());
        bottomSheetRv.setLayoutManager(new GridLayoutManager(getContext(), 2));
        bottomSheetRv.addItemDecoration(new GridSpacingItemDecoration(2, DpUtil.dp2px(16), false));
        if (adapter == null) {
