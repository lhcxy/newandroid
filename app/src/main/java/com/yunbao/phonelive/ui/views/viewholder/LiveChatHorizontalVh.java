 ...
 * 直播聊天 item
 */
public class LiveChatHorizontalVh extends RecyclerView.ViewHolder {
    private TextView contentTv;
    private ForegroundColorSpan nameSp, contentSp, sysMsgSp, giftNameSp;
    private ImageView giftIcon;
    private UserLevelView levelView;

    public LiveChatHorizontalVh(@NonNull ViewGroup parent, OnItemClickListener<String> listener) {
        super(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_live_chat_horizontal, parent, false));
        ...
        nameSp = new ForegroundColorSpan(itemView.getResources().getColor(R.color.text_color_88));
        contentSp = new ForegroundColorSpan(itemView.getResources().getColor(R.color.text_color_333));
