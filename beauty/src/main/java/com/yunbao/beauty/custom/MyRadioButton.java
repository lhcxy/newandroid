...
public class MyRadioButton extends RadioButton {
    ...
    public MyRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDrawableSize = (int) ta.getDimension(R.styleable.MyRadioButton_drawableSize1, dp2px(20));
        mTopDrawableSize = (int) ta.getDimension(R.styleable.MyRadioButton_top_drawableSize1, mDrawableSize);
        mLeftDrawableSize = (int) ta.getDimension(R.styleable.MyRadioButton_left_drawableSize1, mDrawableSize);
        mRightDrawableSize = (int) ta.getDimension(R.styleable.MyRadioButton_right_drawableSize1, mDrawableSize);
        mBottomDrawableSize = (int) ta.getDimension(R.styleable.MyRadioButton_bottom_drawableSize1, mDrawableSize);
        mTopDrawable = ta.getDrawable(R.styleable.MyRadioButton_top_drawable1);
        mLeftDrawable = ta.getDrawable(R.styleable.MyRadioButton_left_drawable1);
        mRightDrawable = ta.getDrawable(R.styleable.MyRadioButton_right_drawable1);
        mBottomDrawable = ta.getDrawable(R.styleable.MyRadioButton_bottom_drawable1);
        ta.recycle();
